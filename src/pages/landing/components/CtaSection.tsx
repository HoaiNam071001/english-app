  ...
  return (
    <section className="relative py-16 md:py-24">
      <div className="mx-auto max-w-5xl px-4 md:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-border bg-card/70 px-6 py-14 text-center backdrop-blur-xl sm:px-12">
            <GradientBlob
              className="left-1/2 top-1/2 h-[24rem] w-[24rem] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-brand-start/20 via-brand-mid/20 to-brand-end/15"
              duration={20}
            />
